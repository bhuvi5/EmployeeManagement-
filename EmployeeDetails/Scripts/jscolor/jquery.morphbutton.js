(function ($) {
    ...
    MorphButton.prototype = {
        ...
        init: function () {
            ...
            morphbutton.buttonClose1 = morphbutton.target.find('.morphbutton-close1');
            morphbutton.buttonClose2 = morphbutton.target.find('.morphbutton-close2');
            ...
            morphbutton.buttonClose1.click(function (evt) {
                //morphbutton.action();
                morphbutton.close();
                return false;
            });

            morphbutton.buttonClose2.click(function (evt) {
                //morphbutton.action();
                morphbutton.close();
                return false;
            });
